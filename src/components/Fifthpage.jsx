  ...
  return (
    <div className="relative h-screen bg-gray-300 ">
      ...
      <div className="flex h-full ml-auto items-center  4 justify-center relative">
        ...
        />
        <div className='absolute  h-screen  flex justify-end items-center  '><div className='w-[20%]'></div><motion.p whileInView={{ opacity: 1,x:0}} initial={{opacity:0,x:-100}} transition={{duration:0.5}} className='w-[38%]  z-20 mr-6 text-white '>
        ...
        <div className='py-[6%] text-white  flex  w-full px-16 '><motion.p whileInView={{ opacity: 1,x:0}} initial={{opacity:0,x:100}} transition={{duration:0.5}} className='h-[90%]  font-bold text-2xl '>TOP TOP ACHIEVEMENTS</motion.p><div className='w-[20%]'></div></div>
        </div>
