          ...
          <div className="flex flex-col justify-between w-[63%] ">
            ...
            <div className="h-3/6 flex flex-col justify-around">
              ...
              <p className="text-gray-500 w-10/12">
                ...
                standards. We have quality standard certificates attained after properly proven
                tests to ensure and fulfill customer requirements. In addition to that, we are
                dedicated to providing advanced technical support to the customers who would like
