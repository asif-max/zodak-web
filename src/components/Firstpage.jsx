    ...
    <div className="h-screen ">
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="flex-grow flex flex-row  ml-[7%]">
          <div className="flex flex-col justify-between border w-[63%] border-black">
            ...
            <div className=" h-3/6 flex flex-col justify-around ">
              ...
              <p className="text-gray-500 w-10/12 ">
                ...
                advanced technical support to the customers who would
                like to improve their quality of services.
              </p>
            ...
            <div className="
             flex flex-row items-center mb-14">
          ...
          <div className="w-[37%] border- border-black "><img src={slide1} alt="" className="w-full"/>
          </div>
        </div>{" "}
