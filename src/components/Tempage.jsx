  ...
  return (
    <div className="flex flex-row bg-white">
      <div className="relative h-screen w-10/12">
        ...
        <motion.h1 whileInView={{ opacity: 1,x:0}} initial={{opacity:0,x:-100}} transition={{duration:0.5}} className="absolute top-1/2 left-[29%] text-4xl text-end font-bold text-white">
